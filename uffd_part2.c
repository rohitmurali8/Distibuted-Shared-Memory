...
main(int argc, char *argv[])
{
	...
	if (argc == 2 && strcmp(argv[1],server) == 0){
		...
		/* [C2: point 1]
		 * Initializes all variables of the serv_addr structure as 0 and then assign values 
		 * to the variables as AF_NET family and given PORT number.
		 */
		...
		/* [C3: point 1]
	 	* Convert IPv4 and IPv6 addrresses from text to binary.
	 	*/
		...
		/* [C4: point 1]
	 	* System call which connects the socket specified in sock to the address specified by 
	 	* serv_addr.
	 	*/
	 ...
	 */
		...
		getchar();
         /* [C5: point 1]
	 * Waiting for user input to transfer data between client and server.
	 */
	...
	/* [C6: point 1]
	 * Send message specified in variable hello and then print the sent confirmation.
	 */
